    ...
    for (var i = 0; i < 32; i++) {
        ...
        data.forEach(indx => {
            ...
            if (indx.cluster == i) {
                ...
                group_stats['avg_overall'] = indx.review_overall_per_cluster;
                group_stats['avg_taste'] = indx.review_taste_per_cluster;
                group_stats['avg_palate'] = indx.review_palate_per_cluster;
                group_stats['avg_aroma'] = indx.review_aroma_per_cluster;
                group_stats['avg_appearance'] = indx.review_appearance_per_cluster;
                group_stats['total_per_cluster'] = indx.cluster_total_reviews;
                group_stats['total_users_per_cluster'] = indx.cluster_total_users;
