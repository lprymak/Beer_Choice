    ...
    function component() {
        _selection.each(function (data) {
            ...
            function onKeyUp() {
                ...
                if ((e.which == 8 || e.which == 46) && _searchTerm == "") {
                    hideSearching();
                    hideDropDown();
                    ...
                    else if (isNewClearNeeded(_searchTerm,_lastSearchTerm)) {
                        hideSearching();
                        hideDropDown();
                    }
            ...
            function isNewClearNeeded(newTerm, oldTerm) {
                return newTerm.length < _minLength && newTerm != oldTerm;
            }
